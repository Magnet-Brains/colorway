...
//			'name'         => 'Colorway Sites', // The plugin name.
//			'slug'         => 'colorway-sites', // The plugin slug (typically the folder name).
//			'source'       => 'https://www.inkthemes.com/wp-content/uploads/colorway-sites.zip', // The plugin source.
//			'required'     => false, // If false, the plugin is only 'recommended' instead of required.
//			'external_url' => 'https://www.inkthemes.com/wp-content/uploads/colorway-sites.zip', // If set, overrides default API URL and points to an external URL.
//			),
			array(
			'name'         => 'Elementor', // The plugin name.
			'slug'         => 'elementor', // The plugin slug (typically the folder name).
			'source'       => 'https://wordpress.org/plugins/elementor/', // The plugin source.
			'required'     => false, // If false, the plugin is only 'recommended' instead of required.
			'external_url' => 'https://wordpress.org/plugins/elementor/', // If set, overrides default API URL and points to an external URL.
			),
